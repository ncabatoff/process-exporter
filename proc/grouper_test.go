...
func (s MySuite) TestGrouperBasic(c *C) {
	...
	p1 := newProc(1, "g1", ProcMetrics{1, 1.5, 2, 3, 4, 5, 4, 400, 6, 7, 2})
	p2 := newProc(2, "g2", ProcMetrics{2, 2.5, 3, 4, 5, 6, 40, 400, 7, 8, 3})
	...
	p1.ProcMetrics = ProcMetrics{2, 2.5, 3, 4, 5, 6, 4, 400, 7, 8, 2}
	p2.ProcMetrics = ProcMetrics{4, 4.5, 5, 6, 7, 8, 40, 400, 9, 10, 3}
	...
	// though.
	p4 := newProc(4, "g2", ProcMetrics{1, 1, 1, 1, 1, 1, 80, 400, 1, 1, 7})
	p2.ProcMetrics = ProcMetrics{5, 5.5, 6, 7, 8, 9, 40, 400, 10, 11, 4}
	...
	p4.ProcMetrics = ProcMetrics{2, 2, 2, 2, 2, 2, 100, 400, 2, 2, 7}
	p2.ProcMetrics = ProcMetrics{6, 6.5, 7, 8, 8, 9, 40, 400, 11, 12, 4}
