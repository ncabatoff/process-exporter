...
func (s MySuite) TestTrackerCounts(c *C) {
	...
	// Test that p1 is seen as new
	p1 := newProc(1, 1, "p1", ProcMetrics{1, 1.5, 2, 3, 4, 5, 6, 4096, 7, 8})
	want1 := []ProcIdInfo{p1}
	...
	p1.ProcMetrics = ProcMetrics{2, 2.5, 3, 4, 5, 6, 7, 4096, 8, 9}
	...
	p1.ProcMetrics = ProcMetrics{4, 5, 6, 8, 9, 10, 11, 4096, 12, 13}
